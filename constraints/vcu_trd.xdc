...
set_property PACKAGE_PIN AJ12 [get_ports si570_user_clk_n]
set_property IOSTANDARD LVDS [get_ports si570_user_clk_p]
set_property IOSTANDARD LVDS [get_ports si570_user_clk_n]
...
set_property IOSTANDARD LVCMOS12 [get_ports GPIO_SW_*]
...
set_property PULLTYPE PULLUP [get_ports sensor_iic_scl_io]
set_property PULLTYPE PULLUP [get_ports sensor_iic_sda_io]
